...
| **图源** | 国内 + 海外 14+ 公开图库、4 档版权分级；**国内可访问源前置（沙沙野 + Pexels / Pixabay 中文站）、开箱即用不翻墙**，海外源高质量补充（源清单带核验日期，可热更） |
...
2. **公开免费图库**——你没有图时，从**国内 + 海外 14+ 公开源**里找：**国内可访问源（沙沙野 ssyer.com、Pexels / Pixabay 中文站、hippopx 备选）前置、不用翻墙**，**海外 Unsplash / StockSnap 等作高质量补充**；按 4 档版权分级，CC0 / 公共领域优先。（cc0.cn 作人工浏览入口；泼辣有图、别样网已关站——源清单带核验日期 2026-07-08，可热更）
...
**Q：没有图怎么办？**
A：优先用你自己的照片 / 截图；没有就从免费图库找（国内可访问源前置：沙沙野 + Pexels/Pixabay 中文站，海外源补充），会记录来源；都没有才克制地用 AI 生图。
